""" Read data from MCP3008 inputs.

A low-level Class to read data from inputs to the MCP3008
analogue-to-digital converter (ADC) chip. This communicates using SPI.
